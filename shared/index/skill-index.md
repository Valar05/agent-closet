...
| Model Mechanical Hard Surfaces | `skills/model-mechanical-hard-surfaces.md` | Authoring persistent, editable, animated mechanical assets through Home Center with Blender as the kernel. |
