...
5. Read `shared/doctrine/intent-integrity-bounded-initiative.md` before interpreting or improving a user's request.
6. Read `shared/doctrine/visual-truth-authority.md` if the task involves visual output, screenshots, video, cloud visual parity, or a red-build report.
7. Read `shared/index/agent-index.md` if the task involves agent routing or agent design.
8. Read `shared/index/skill-index.md` if the task involves a reusable behavior, procedure, template, or theory.
...
- `shared/doctrine/intent-integrity-bounded-initiative.md`: user-word authority, improvement freedom, mission-boundary, no-substitution, and regression-soup doctrine.
